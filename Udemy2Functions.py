...
def get_todos(): #in order to optimise the code I have added cutom function. That's helped to reduce repetitive code.
    ...
    with open('/Users/savchik/Desktop/python/Learning/1 app/todos.txt', 'r') as file_local: #also we can chose changable option: def get_todos(filepath):  with open (filepath, r)..... todos = get_todos(filepath)
        todos_local = file_local.readlines()
    return todos_local 

def write_todos(arg_todos, filepath = '/Users/savchik/Desktop/python/Learning/1 app/todos.txt'): #here i mentioned two variables. First variable is the different option to input the value (as I wrote in 2 row). Second var is a variable from 31 line (todos)
